...
import com.example.clone_calories_app.Adapter.DishListViewAdapter;
...
public class DishActivity extends AppCompatActivity {
    ...
    Dish tempDish;
    DishListViewAdapter myDishesViewAdapter;
...
//        dishesList.add(new Dish("Salad",50,5,10,50,Dish.enumFood.fishAndSeaFood,R.drawable.salad));
        ...
        myDishesViewAdapter = new DishListViewAdapter(dishesList,DishActivity.this);
